...
const APPID = "223aa5f7"; // TODO 你的讯飞模型APPID
const API_SECRET = "YTQ4YjBlZDc0ODc3MmJiNzdhZmNmMDU5"; // TODO 你的讯飞模型API_SECRET
const API_KEY = "d9f31dc61f341af85b432f1db9733975"; // TODO 你的讯飞模型API_KEY
let iatWS; //监听录音的变量
...
recorder.onFrameRecorded = ({ isLastFrame, frameBuffer }) => {
  console.log(isLastFrame, frameBuffer, '1111');
